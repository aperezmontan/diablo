...
#           expect(PoolUpdater).to receive(:execute).with(pools: game.pools, game)
...
#         it 'returns an PoolUpdater error' do
#           expect{ subject }.to raise_error(PoolUpdaterError, 'Invalid attributes: attempted to change home_team but game is active')
#         end
#       end
...
#           it 'returns an PoolUpdater error' do
#             expect{ subject }.to raise_error(PoolUpdaterError, 'Invalid attributes: {:bar=>"yuuurrr"}')
#           end
#         end
...
#           it 'returns an PoolUpdater error' do
#             expect{ subject }.to raise_error(PoolUpdaterError, 'Expecting Game, received nil')
#           end
#         end
...
#           it 'returns an PoolUpdater error' do
#             expect{ subject }.to raise_error(PoolUpdaterError, 'Expecting Game, received Pool')
#           end
#         end
#       end
#     end
